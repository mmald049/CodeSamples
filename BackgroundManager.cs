...
//Move chunks of blocks in a snake-like pattern to create an illusion of an endlessly moving background
public class BackgroundManager : MonoBehaviour
{
    ...
    private Transform GetLocalPlayer()//return local client player
    {
